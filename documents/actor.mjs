...
export class HypermallActor extends Actor {
  ...
  prepareDerivedData() {
    ...
    const flags = actorData.flags.hypermall || {};

    // Make separate methods for each Actor type (character, npc, etc.) to keep
    // things organized.
    this._prepareContractorData(actorData);
   ...
   */
  _prepareContractorData(actorData) { }
  ...
  getRollData() {
    ...
    this._getContractorRollData(data);
